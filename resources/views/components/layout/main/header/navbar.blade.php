...
<div class="app-navbar flex-shrink-0">
    ...
    {{--            {!! Themes::svgIcon('general/gen032.svg', 'svg-icon svg-icon-2 svg-icon-md-1') !!}--}}
    {{--        </div>--}}
    {{--        <!--end::Drawer toggle-->--}}
    {{--    </div>--}}
    <!--end::Activities-->
    ...
    <!--begin::Theme mode-->
    <div class="app-navbar-item ms-1 ms-md-3">
        <x-layout.main.theme-mode.switcher/>
    </div>
    <!--end::Theme mode-->
    <!--begin::User menu-->
    <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
            ...
            <img src="{{Themes::asset('media/avatars/300-1.jpg')}}" alt="user"/>
        </div>
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo" src="{{Themes::avatar(auth()->user()->name)}}"/>
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
    ...
    <div class="app-navbar-item d-lg-none ms-2 me-n3" title="Show header menu">
        <div class="btn btn-icon btn-active-color-primary w-30px h-30px w-md-35px h-md-35px"
            ...
            {!! Themes::svgIcon('text/txt001.svg', 'svg-icon svg-icon-2 svg-icon-md-1') !!}
        </div>
    </div>
